...
const News = ({ onShowBlogs, blogs, onEditBlog, onDeleteBlog }) => {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      let url = `https://gnews.io/api/v4/top-headlines?category=${selectedCategory}&lang=en&apikey=ebeca60b4cdbfbe3c5778b461deee562`;

      if (searchQuery) {
      url = `https://gnews.io/api/v4/search?q=${searchQuery}&lang=en&apikey=ebeca60b4cdbfbe3c5778b461deee562`;
      }
